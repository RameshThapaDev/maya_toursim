...
export default function AdminVehiclesPage() {
  ...
  const handleConfirmedSubmit = async () => {
    ...
    loadItems();
    toast({
      title: form.id ? "Vehicle updated" : "Vehicle created",
      status: "success",
      duration: 2500,
      isClosable: true
    });
            ...
            <AlertDialogOverlay>
              <AlertDialogContent>
                <AlertDialogHeader fontSize="lg" fontWeight="bold">
                  {confirm.type === "delete" ? "Delete vehicle" : "Confirm changes"}
                </AlertDialogHeader>
                <AlertDialogBody>
                  {confirm.type === "delete"
                    ? "Are you sure you want to delete this vehicle?"
                    : "Save these vehicle changes?"}
                </AlertDialogBody>
                <AlertDialogFooter>
